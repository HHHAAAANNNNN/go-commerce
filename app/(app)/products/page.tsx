                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className={`w-4 h-4 ${product.total_reviews > 0 && i < Math.floor(product.rating) ? 'text-yellow-400 fill-current' : 'text-slate-600'}`}
                        viewBox="0 0 20 20"
                      >
                  ...
                  {product.total_reviews > 0
                    ...
                    : <span className="text-slate-600 text-xs">No reviews</span>
                  }
                </div>
