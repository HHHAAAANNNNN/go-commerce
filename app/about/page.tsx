...
// A reusable placeholder component for images
...
export default function AboutPage() {
    ...
    const aboutImages = [0, 1, 2]; // Simulated image indices to map over
                ...
                <div className="max-w-5xl mx-auto px-4 space-y-20">
                    ...
                    <section className="fade-up animate-delay-100">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                            ...
                            <div className="space-y-4">
                                <div className="w-full relative rounded-2xl overflow-hidden ring-1 ring-slate-700/50 shadow-2xl transition-all duration-300" style={{ aspectRatio: '2/1' }}>
                                    {/* Replace this placeholder with the actual large image */}
                                ...
                                <div className="grid grid-cols-3 gap-3 md:gap-4">
                                    {aboutImages.map((idx) => (
                                        <div
                                            ...
                                            className={`relative rounded-xl overflow-hidden cursor-pointer transition-all duration-300 ${activeImage === idx
                                        ...
                                        >
                                            {/* Replace this placeholder with thumbnails */}
                                            <ImagePlaceholder className="absolute inset-0 w-full h-full text-slate-700" />
                                        </div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <section className="fade-up animate-delay-200">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="group flex flex-col md:flex-row items-center gap-8 bg-slate-800/20 rounded-2xl border border-slate-800/50 p-6 hover:bg-slate-800/40 hover:border-slate-700/80 transition-all duration-300">
                                <div className="w-full md:w-1/3 aspect-video shrink-0 rounded-xl overflow-hidden ring-1 ring-slate-700/50">
                                    {/* Dummy Image */}
                                    <ImagePlaceholder className="w-full h-full" />
                                </div>
                                <div className="w-full md:w-2/3 space-y-4">
                                    <div>
                                        <h3 className="text-2xl font-bold text-white group-hover:text-primary-400 transition-colors">Program Manager & Full-Stack Intern</h3>
                            ...
                            {/* Project 2 */}
                            <div className="group flex flex-col md:flex-row items-center gap-8 bg-slate-800/20 rounded-2xl border border-slate-800/50 p-6 hover:bg-slate-800/40 hover:border-slate-700/80 transition-all duration-300">
                                <div className="w-full md:w-1/3 aspect-video shrink-0 rounded-xl overflow-hidden ring-1 ring-slate-700/50 md:order-2">
                                    <ImagePlaceholder className="w-full h-full" />
                                </div>
                                <div className="w-full md:w-2/3 space-y-4 md:order-1">
                                    ...
                                    <p className="text-slate-300 leading-relaxed italic">
                                        "Accomplished 100% accuracy in employee performance metrics as measured by rigorous data validation outputs, by successfully verifying and implementing intricate Workload Priority Time (WPT) calculation formulas."
                                    </p>
                                    <div className="flex flex-wrap gap-2">
                            ...
                            <div className="group flex flex-col md:flex-row items-center gap-8 bg-slate-800/20 rounded-2xl border border-slate-800/50 p-6 hover:bg-slate-800/40 hover:border-slate-700/80 transition-all duration-300">
                                ...
                                <div className="w-full md:w-2/3 space-y-4">
                                    ...
                                    <p className="text-slate-300 leading-relaxed italic">
                                        "Accomplished international prestige as the Runner-Up at the ASEAN Impact Challenge 2025 as measured by prevailing over 50+ regional candidates, by architecting a scalable Zero-Waste Food Ecosystem Platform resolving food insecurity issues."
                                    </p>
                                    <div className="flex flex-wrap gap-2">
                    ...
                    <section className="fade-up animate-delay-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/60 p-6 rounded-2xl border border-slate-700/50 hover:border-primary-500/50 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-amber-500/10 rounded-full flex items-center justify-center mb-4 text-amber-400">
                                ...
                                <p className="text-sm text-slate-400 italic">"Accomplished the Runner-Up title as measured by a top placement among 50+ candidates, by developing a high-impact social innovation."</p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/60 p-6 rounded-2xl border border-slate-700/50 hover:border-primary-500/50 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-slate-400 italic">"Accomplished national recognition as measured by an award for superior technical execution, by applying rigorous software engineering principles."</p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/60 p-6 rounded-2xl border border-slate-700/50 hover:border-primary-500/50 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-slate-400 italic">"Accomplished a 2nd Runner-Up placement as measured by university-wide evaluation, by engineering an AI-integrated English learning platform."</p>
                            </div>
