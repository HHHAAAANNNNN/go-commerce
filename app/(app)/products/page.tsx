          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="relative h-48 bg-slate-800/50 overflow-hidden">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900 via-slate-900/95 to-transparent transition-all duration-300 group-hover:via-slate-900/98 group-hover:from-slate-900 pt-16 group-hover:pt-24 pb-4 px-4">
